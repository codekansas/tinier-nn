...
The script itself trains a binary network to perform a simple XOR
classification task (although this could be extended to other tasks). The
weights are saved to an output file which can be read by the C evaluation
code (in particular, eval/run.c demonstrates how to build input vectors and
